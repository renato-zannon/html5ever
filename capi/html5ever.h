...
struct h5e_token_ops {
    void (*do_doctype)(void *user, struct h5e_buf name, struct h5e_buf pub, struct h5e_buf sys, int force_quirks);
    ...
    void (*do_characters)(void *user, struct h5e_buf text);
    void (*do_null_character)(void *user);
